...
**See also**: `primitives/adapters/v1/x86@loopback/adapter.c` for reference implementation
...
### x86@loopback (stdin/stdout)
See `primitives/adapters/v1/x86@loopback/adapter.c` - production reference implementation.
...
Platform-specific - see `load_kernel_plugin()` in x86@loopback adapter for dlopen() example.
...
- **Reference Adapter**: `primitives/adapters/v1/x86@loopback/adapter.c`
