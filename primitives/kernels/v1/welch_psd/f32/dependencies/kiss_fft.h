...
#define KISS_FFT_ERROR(m) fprintf(stderr, "KISS_FFT_ERROR: %s\n", m)
#endif
#ifndef KISS_FFT_WARNING
#define KISS_FFT_WARNING(m) fprintf(stderr, "KISS_FFT_WARNING: %s\n", m)
#endif
#ifndef KISS_FFT_DEBUG
#define KISS_FFT_DEBUG(m, ...)                                                 \
  fprintf(stderr, "KISS_FFT_DEBUG: " m, __VA_ARGS__)
#endif
