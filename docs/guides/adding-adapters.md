...
**Reference Implementation:** `primitives/adapters/v1/x86@loopback/`
...
- [ ] Reference adapter built (`make -C primitives/adapters/v1/x86@loopback/`)
...
2. **Study reference implementations:**
   - x86@loopback: `primitives/adapters/v1/x86@loopback/`
