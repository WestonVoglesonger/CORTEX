...
cortex_plugin_info_t cortex_get_info(void) {
    ...
    info.name = "goertzel";
    info.description = "Goertzel algorithm for computing bandpower (alpha 8-13 Hz, beta 13-30 Hz)";
    info.version = "1.0.0";
...
void cortex_process(void *handle, const void *input, void *output) {
    ...
    /* Size: TOTAL_BINS * channels for each array (s0, s1, s2) */
    /* For default 64 channels and 23 bins: 64 * 23 * 3 * 8 bytes = ~35 KB */
